    ...
    return (
        <Router>
            <Routes>
                ...
                />
                <Route
                    path="/:role/manage-account"
                    element={
                        <PrivateRoute roleRequired={["admin", "superadmin"]}>
                            <Profile />
                        </PrivateRoute>
                    }
                />
                <Route
                    path="/:role/faculty-is"
                    element={
                        <PrivateRoute roleRequired={["superadmin"]}>
                            <FacultyIS />
                        </PrivateRoute>
                ...
                <Route
                    path="/system-settings/facilities-manager"
                    element={
                        <PrivateRoute roleRequired={["superadmin"]}>
                            <FacilitiesManagerManagement />
                        </PrivateRoute>
                    }
                />

                <Route
                    path="/system-settings/posting-management"
                    element={
                        <PrivateRoute roleRequired={["superadmin"]}>
                            <PostingManagement />
                        </PrivateRoute>
                ...
                />
                <Route
                    path="/system-settings/programs-management"
                    element={
                        <PrivateRoute roleRequired={["superadmin"]}>
                            <ProgramsManagerManagement />
                        </PrivateRoute>
                    }
                />
                <Route
                    path="/system-settings/terms-management"
                    element={
                        <PrivateRoute roleRequired={["superadmin"]}>
                            <TermsManagement />
                        </PrivateRoute>
