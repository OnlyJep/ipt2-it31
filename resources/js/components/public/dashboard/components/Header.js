...
const Header = ({ style, toggleSidebar, toggleMobileSidebar }) => {
    ...
    const recommendations = [
        ...
        { label: "Academic Programs", route: `/superadmin/academic-programs` },
        {
            ...
            route: `/superadmin/subject-enlistment`,
        },
        { label: "Classroom Manager", route: `/superadmin/classroom-manager` },
        {
            label: "System Settings > Facilities Manager",
            route: `/system-settings/facilities-manager`,
        },
        {
            label: "System Settings > Programs Management",
            route: `/system-settings/programs-management`,
        },
        {
            label: "System Settings > Terms Management",
            route: `/system-settings/terms-management`,
        },
        {
            label: "System Settings > Posting Management",
            route: `/system-settings/posting-management`,
        },
    ];
    ...
    const getCurrentSection = () => {
        const matchedItem = recommendations.find((item) =>
    ...
    const debouncedSearch = useCallback(debounce(handleSearch, 300), [
        filteredRecommendationsForSearch,
        user,
    ]);
    ...
    const handleInputChange = (e) => {
        ...
        if (value) {
            const filtered = filteredRecommendationsForSearch.filter(
                (item) => item.label.toLowerCase().includes(value) // Check if search term is anywhere in the label
            );
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <MenuOutlined
                            style={{ fontSize: "24px", color: "#3f7afc" }}
                        />
                    </div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <DownOutlined
                                style={{ fontSize: "16px", color: "#3f7afc" }}
                            />
                        </div>
                    </Dropdown>
                </div>
